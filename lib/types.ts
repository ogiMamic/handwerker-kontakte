// ============================================================
// handwerker-kontakte.de — Core Types
// ============================================================
...
export const GEWERK_LABELS: Record<GewerkType, string> = {
  ...
  schluessseldienst: 'Schlüsseldienst',
  umzugsunternehmen: 'Umzugsunternehmen',
  reinigungsdienst: 'Reinigungsdienst',
  bodenleger: 'Bodenleger',
};

// Top-Städte für die wir Seiten generieren
...
// Filter params for URL query
export interface FilterParams {
  stadt?: string;
  gewerk?: GewerkType;
  bewertung_min?: number; // min stars
  preis_max?: number; // max hourly rate
